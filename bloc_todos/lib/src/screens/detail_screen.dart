...
class DetailsScreen extends StatelessWidget {
  ...
  DetailsScreen({Key key, @required this.id,@required this.todosBloc});
                              ...
                              child: Checkbox(
                                  ...
                                  onChanged: (_) {
                                    BlocProvider.of<TodosBloc>(context).add(
                                      TodoUpdated(
                                        updatedTodo:todo.copyWith(complete: !todo.complete),
                                      ),
                                    );
                                  }),
                            ),
                          ...
                          builder: (_) {
                            return AddEditScreen(
                              ...
                              onSave: (task, note) {
                                BlocProvider.of<TodosBloc>(context).add(
                                  TodoUpdated(
                                    updatedTodo:todo.copyWith(task: task, note: note),
                                  ),
                                );
                              },
                              isEditing: true,
